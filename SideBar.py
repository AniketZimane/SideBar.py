...
from OpenCVModule import scancard
...
homeframe = tk.Frame(root, width=1000, height=600, bd=10, bg="#053246",command="scanIdCard", border=5, highlightthickness=2,
                     highlightbackground="white").place(x=300, y=150)
tk.Button(homeframe, text="", image=scanimg, font="kokila 15 bold", padx=200, pady=200,
